...
describe "Image" do
  ...
  it "passes for existing external images" do
    ...
    @imageCheck = ::HTML::Proofer::Checks::Check::Images.new(externalImageFilepath, @htmlProofer.create_nokogiri(externalImageFilepath))
    @imageCheck.run
  ...
  it "fails for image without alt attribute" do
    ...
    @imageCheck = ::HTML::Proofer::Checks::Check::Images.new(missingAltFilepath, @htmlProofer.create_nokogiri(missingAltFilepath))
    @imageCheck.run
  ...
  it "fails for image without a dir prefix" do
    ...
    @imageCheck = ::HTML::Proofer::Checks::Check::Images.new(missingImageDirPrefixFilepath, @htmlProofer.create_nokogiri(missingImageDirPrefixFilepath))
    @imageCheck.run
